...
variable "subnet" {
  ...
  default = {
    "1" = "172.16.136.0/26"  		# External IPv4
    "2" = "172.16.136.64/26" 		# Internal IPv4
    "3" = "172.16.137.0/24"  		# Protected a IPv4
    "4" = "172.16.138.0/24"  		# Protected b IPv4
	"5" = "ace:cab:deca::/64"  		# External IPv6
    "6" = "ace:cab:deca:10::/64" 	# Internal IPv6
    "7" = "ace:cab:deca:20::/64"  	# Protected a IPv6
    "8" = "ace:cab:deca:30::/64"  	# Protected b IPv6
...
variable "subnetmask" {
  ...
  default = {
    "1" = "26" # External IPv4
    "2" = "26" # Internal IPv4
    "3" = "24" # Protected a IPv4
    "4" = "24" # Protected b IPv4
	"5" = "64" # External IPv6
    "6" = "64" # Internal IPv6
    "7" = "64" # Protected a IPv6
    "8" = "64" # Protected b IPv6
  }
}
...
variable "fgt_ipaddress" {
  ...
  default = {
    "1" = "172.16.136.4"  		# External Primary IPv4
    "2" = "ace:cab:deca::5" 	# External Primary IPv6
	"3" = "172.16.136.40"  		# External Secondary IPv4
    "4" = "ace:cab:deca::4" 	# Internal Secondary IPv6
    "5" = "172.16.136.68" 		# Internal IPv4
	"6" = "ace:cab:deca:10::4"  # Internal IPv6 
...
variable "gateway_ipaddress" {
  ...
  default = {
    "1" = "172.16.136.1"  # External IPv4
    "2" = "172.16.136.65" # Internal IPv4
	"3" = "ace:cab:deca::1"  # External IPv6
    "4" = "ace:cab:deca:10::1" # Internal IPv6
...
variable "fortinet_tags" {
  ...
  default = {
    publisher : "Fortinet",
    template : "A-Single-VM-DualStack",
