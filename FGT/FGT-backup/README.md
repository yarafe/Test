...
- Taking Azure-managed disk snapshots at scheduled intervals: We can restore faulty disks or replace disks. This method uses scheduled snapshots of Azure-managed disks. Snapshots provide fast, flexible disk-level recovery.
  - Restore with Disks Snapshots
